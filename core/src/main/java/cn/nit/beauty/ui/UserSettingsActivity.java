        ...
        if (user != null) {
            ...
            if (null != avatarFile) {
                ImageLoader.getInstance()
                        .displayImage(avatarFile.getFileUrl(this), userIcon,
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                ...
                case EDIT_SIGN:
                    ...
                    break;
                case EDIT_PASSWORD:
                    user.setPassword(data.getStringExtra("content"));
                    user.update(UserSettingsActivity.this);
                    ActivityUtil.show(this, "修改密码成功");
                    break;
                case 1:
        ...
        if (avataPath != null) {
            ...
            file.upload(this, new UploadFileListener() {
                ...
                public void onSuccess() {
                    ...
                    L.i("上传文件成功。" + file.getFileUrl(UserSettingsActivity.this));
